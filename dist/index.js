...
const setAWSCredentials = () => {
    ...
    global_1.default.config.credentials = {
        accessKeyId,
        secretAccessKey,
        sessionToken,
    };
...
function run() {
    try {
        setAWSCredentials();
        setAWSConfigOptions();
        const lambda = new lambda_1.default({ apiVersion, region: (0, core_1.getInput)('REGION') });
        const params = {
        ...
        lambda.waitFor('functionUpdatedV2', params, (error, data) => {
            ...
            (0, core_1.setOutput)("update-status", (_a = data.Configuration) === null || _a === void 0 ? void 0 : _a.LastUpdateStatus);
        });
    }
    catch (error) {
...
Object.defineProperty(apiLoader.services['lambda'], '2014-11-11', {
  get: function get() {
    var model = __nccwpck_require__(3935);
    model.paginators = __nccwpck_require__(6208)/* .pagination */ .o;
    return model;
  },
  enumerable: true,
  configurable: true
...
Object.defineProperty(apiLoader.services['lambda'], '2015-03-31', {
  get: function get() {
    var model = __nccwpck_require__(409);
    model.paginators = __nccwpck_require__(8920)/* .pagination */ .o;
    model.waiters = __nccwpck_require__(7582)/* .waiters */ .V;
    return model;
  },
  enumerable: true,
  configurable: true
